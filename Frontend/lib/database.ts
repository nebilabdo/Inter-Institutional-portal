...
export async function createInstitution(institution: Omit<Institution, "id" | "createdAt">): Promise<Institution> {
  return new Promise((resolve) => {
    setTimeout(() => {
...
export async function updateInstitution(id: string, updates: Partial<Institution>): Promise<Institution | null> {
  return new Promise((resolve) => {
    setTimeout(() => {
...
export async function createAPIRequest(request: Omit<APIRequest, "id" | "submittedDate">): Promise<APIRequest> {
  return new Promise((resolve) => {
    setTimeout(() => {
...
export async function updateAPIRequest(id: string, updates: Partial<APIRequest>): Promise<APIRequest | null> {
  return new Promise((resolve) => {
    setTimeout(() => {
